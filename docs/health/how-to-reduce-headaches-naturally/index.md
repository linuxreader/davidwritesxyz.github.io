...
{{< icon "check" >}} Numbness  
{{< icon "check" >}} Tingling  
{{< icon "check" >}} Weird sensations in chest, shoulder, arm, neck, and hand  
...
{{< icon "check" >}} Working long hours with hands out in front of you 
{{< icon "check" >}} Stress from caffeine, alcohol, or nicotine use
...
{{< icon "check" >}} Bad head posture  
{{< icon "check" >}} Other trigger points or muscle imbalance  
{{< icon "check" >}} Whiplash  
...
{{< icon "check" >}} Tight abs  
{{< icon "check" >}} Working long hours with hands out in front of you   
{{< icon "check" >}} Emotional tension that keeps your shoulders up  
