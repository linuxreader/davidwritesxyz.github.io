...
{{< gallery >}}
  ...
  <img src="infinitygauntlet.jpg" class="grid-w20 cursor-pointer" onclick="event.stopPropagation(); window.open('https://amzn.to/41KoG4Z','_blank'); return false;" />
  <img src="wheretheredferngrows.jpg" class="grid-w20 cursor-pointer" onclick="event.stopPropagation(); window.open('https://amzn.to/4tTZK6S','_blank'); return false;" />
  <img src="maus.jpg" class="grid-w20 cursor-pointer" onclick="event.stopPropagation(); window.open('https://amzn.to/4mAGzwx','_blank'); return false;" />
  <img src="thehobbit.jpg" class="grid-w20 cursor-pointer" onclick="event.stopPropagation(); window.open('https://amzn.to/4mFjY26','_blank'); return false;" />
  <img src="allquietonthewesternfront.jpg" class="grid-w20 cursor-pointer" onclick="event.stopPropagation(); window.open('https://amzn.to/4vFCawx','_blank'); return false;" />
  <img src="infinitejest.png" class="grid-w20 cursor-pointer" onclick="event.stopPropagation(); window.open('https://amzn.to/4tU01qq','_blank'); return false;" />
 <img src="thedeathofivanilyich.jpg" class="grid-w20 cursor-pointer" onclick="event.stopPropagation(); window.open('https://amzn.to/3QwQG9I','_blank'); return false;" />
 <img src="siddartha.jpg" class="grid-w20 cursor-pointer" onclick="event.stopPropagation(); window.open('https://amzn.to/4evVYfF','_blank'); return false;" />
 <img src="tswffgwts.jpg" class="grid-w20 cursor-pointer" onclick="event.stopPropagation(); window.open('https://amzn.to/4sGFqVy','_blank'); return false;" />
 <img src="ttotgp.jpg" class="grid-w20 cursor-pointer" onclick="event.stopPropagation(); window.open('https://amzn.to/3Os1DJe','_blank'); return false;" />
 <img src="tsow.jpg" class="grid-w20 cursor-pointer" onclick="event.stopPropagation(); window.open('https://amzn.to/4mASp9Y','_blank'); return false;" />
 <img src="1q84.jpg" class="grid-w20 cursor-pointer" onclick="event.stopPropagation(); window.open('https://amzn.to/4e2gdl7','_blank'); return false;" />
...
## Writing
{{< gallery >}}
  <img src="twoa.jpg" class="grid-w20 cursor-pointer" onclick="event.stopPropagation(); window.open('https://amzn.to/4mGEfUW','_blank'); return false;" />
  <img src="slaa.jpg" class="grid-w20 cursor-pointer" onclick="event.stopPropagation(); window.open('https://amzn.to/4mD8iNb','_blank'); return false;" />
  <img src="kg.jpg" class="grid-w20 cursor-pointer" onclick="event.stopPropagation(); window.open('https://amzn.to/42g1pb8','_blank'); return false;" />
  <img src="syw.jpg" class="grid-w20 cursor-pointer" onclick="event.stopPropagation(); window.open('https://amzn.to/4mO7o0r','_blank'); return false;" />
  <img src="ew.jpg" class="grid-w20 cursor-pointer" onclick="event.stopPropagation(); window.open('https://amzn.to/4tWxh0q','_blank'); return false;" />
...
## Tech
{{< gallery >}}
  <img src="cap.jpg" class="grid-w20 cursor-pointer" onclick="event.stopPropagation(); window.open('https://amzn.to/4mGM9hd','_blank'); return false;" />
  <img src="csgv1.jpg" class="grid-w20 cursor-pointer" onclick="event.stopPropagation(); window.open('https://amzn.to/41E7pdJ','_blank'); return false;" />
  <img src="csgv2.jpg" class="grid-w20 cursor-pointer" onclick="event.stopPropagation(); window.open('https://amzn.to/4dXSJ0j','_blank'); return false;" />
...
{{< gallery >}}
  <img src="willpowerinstinct.png" class="grid-w20 cursor-pointer" onclick="event.stopPropagation(); window.open('https://amzn.to/4evRRjJ','_blank'); return false;" />
  <img src="dopaminenation.png" class="grid-w20 cursor-pointer" onclick="event.stopPropagation(); window.open('https://amzn.to/4cEtmyt','_blank'); return false;" />
  <img src="nonviolentcommunication.png" class="grid-w20 cursor-pointer" onclick="event.stopPropagation(); window.open('https://amzn.to/41MDwb8','_blank'); return false;" />
  <img src="the12weekyear.png" class="grid-w20 cursor-pointer" onclick="event.stopPropagation(); window.open('https://amzn.to/4mEcgFb','_blank'); return false;" />
  <img src="tribes.png" class="grid-w20 cursor-pointer" onclick="event.stopPropagation(); window.open('https://amzn.to/48KLaqj','_blank'); return false;" />
  <img src="ah.jpg" class="grid-w20 cursor-pointer" onclick="event.stopPropagation(); window.open('https://amzn.to/485gfVy','_blank'); return false;" />
  <img src="t5ac.jpg" class="grid-w20 cursor-pointer" onclick="event.stopPropagation(); window.open('https://amzn.to/4cTICsk','_blank'); return false;" />
  <img src="tmotb.jpg" class="grid-w20 cursor-pointer" onclick="event.stopPropagation(); window.open('https://amzn.to/4cjrEU7','_blank'); return false;" />
  <img src="twotsm.jpg" class="grid-w20 cursor-pointer" onclick="event.stopPropagation(); window.open('https://amzn.to/4cRY882','_blank'); return false;" />
  <img src="tpoh.jpg" class="grid-w20 cursor-pointer" onclick="event.stopPropagation(); window.open('https://amzn.to/4tkRvRw','_blank'); return false;" />
  <img src="tmap.jpg" class="grid-w20 cursor-pointer" onclick="event.stopPropagation(); window.open('https://amzn.to/4mGfzMg','_blank'); return false;" />
  <img src="ybop.jpg" class="grid-w20 cursor-pointer" onclick="event.stopPropagation(); window.open('https://amzn.to/4cABhwI','_blank'); return false;" />
  <img src="ewtss.jpg" class="grid-w20 cursor-pointer" onclick="event.stopPropagation(); window.open('https://amzn.to/4cu1Cwc','_blank'); return false;" />
  <img src="syczwcs.jpg" class="grid-w20 cursor-pointer" onclick="event.stopPropagation(); window.open('https://amzn.to/3OPkMF1','_blank'); return false;" />
  <img src="nmmng.jpg" class="grid-w20 cursor-pointer" onclick="event.stopPropagation(); window.open('https://amzn.to/4tWAv42','_blank'); return false;" />
  <img src="tfaost.jpg" class="grid-w20 cursor-pointer" onclick="event.stopPropagation(); window.open('https://amzn.to/48YnFKq','_blank'); return false;" />
  <img src="teoi.jpg" class="grid-w20 cursor-pointer" onclick="event.stopPropagation(); window.open('https://amzn.to/4tl7HlJ','_blank'); return false;" />
  <img src="wotpw.jpg" class="grid-w20 cursor-pointer" onclick="event.stopPropagation(); window.open('https://amzn.to/4vCZif5','_blank'); return false;" />
  <img src="tmatr.jpg" class="grid-w20 cursor-pointer" onclick="event.stopPropagation(); window.open('https://amzn.to/4sBJEhf','_blank'); return false;" />
...
## Money
{{< gallery >}}
  <img src="100m-offers.png" class="grid-w20 cursor-pointer" onclick="event.stopPropagation(); window.open('https://amzn.to/3OrEkiG','_blank'); return false;" />
  <img src="psychologyofmoney.png" class="grid-w20 cursor-pointer" onclick="event.stopPropagation(); window.open('https://amzn.to/3OLh0fQ','_blank'); return false;" />
